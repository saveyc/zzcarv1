...
#define DEST_IPTHREE_ADDR3  100

#define DEST_PORT_THREE     9902
...
extern u8 opt_inc_flag;
extern u8 opt_inc_cnt;
extern u8 opt_rst_flag;
extern u8 opt_rst_cnt;

extern void Photoeletricity_Process(u8 extIntOpt);

#define	POSTION_JIANGE	    1
#define MOTO_MAX_COUNT1     16
...
#define WAIT_RECV_RUN       3
    ...
    extern void  jisuan_guangdian_timer_( void );
    extern void  jisuan_guangdian_timer( u8 uPinState );
...
#define DEBUG_BUFF_SIZE     50
    ...
    extern u8 Debug_recv_buff_shadow[];
