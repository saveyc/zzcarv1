...
typedef struct
{
    u16 car_load_index_u16;   // index of car to load
    u8  platform_index_u8;    // index of platform to push goods to car
    u16 car_run_time;         //小车电机运行持续时间1~255，单位 10ms
    u16 blank;                //空
    u16 car_wait_time;        //小车电机运转等待时间1~127，单位 10ms
} sCar_Load_Info;
...
#define		SEND_MSG_CAR2WCS_MOTO_TYPE	    0x1140
#define		SEND_MSG_CAR2WCS_HEART_TYPE	    0x1150
#define		RECV_MSG_CAR2WCS_MOTO_TYPE	    0x9140
/**********主动发送回复命令*********/
...
//extern sWCS2Car_CMD_Data wcs2CarCmdData;
//extern sWCS2Car_load_CMD_Data wcs2CarLoadCmdData;
